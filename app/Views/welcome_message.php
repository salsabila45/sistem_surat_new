...
<head>
    <meta charset="UTF-8">
    <title>Welcome to CodeIgniter 40!</title>
...
<!-- 
    ...
    <script src="../path/to/argon-dashboard-tailwind.js"></script>
    <link rel="stylesheet" href="argon-dashboard-tailwind.css" />
